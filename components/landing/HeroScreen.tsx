...
export default function HeroScreen() {
  ...
  return (
    <div className="flex flex-col h-full pt-[42px] px-5 pb-4 font-sans bg-[#fff9f0]">
      ...
      <p className="text-[34px] font-extrabold leading-none tracking-tight mb-5">
      ...
      <div className="grid grid-cols-2 gap-2.5 mb-3">
        <div className="rounded-[18px] bg-orange text-cream p-3.5">
          ...
          <p className="text-[19px] font-bold leading-tight">{formatTenge(scenario.available)}</p>
        </div>
        <div className="rounded-[18px] bg-white border border-ink/[0.07] p-3.5">
          <p className="text-[10.5px] text-ink-soft mb-1">Recommended</p>
          <p className="text-[19px] font-bold leading-tight">{formatTenge(scenario.recommended)}</p>
        </div>
      </div>
      ...
      <div className="rounded-[18px] bg-white border border-ink/[0.07] p-3.5 mb-3 flex items-center justify-between">
        ...
        <div className="flex items-end gap-[3px] h-8">
          {weeklyEarnings.map((v, i) => (
            <div
              key={i}
              className="w-[6px] rounded-full bg-orange/70"
      ...
      <div className="rounded-[18px] bg-ink text-cream p-4 mt-auto mb-4">
        ...
        <p className="text-[19px] font-bold mb-1.5">{formatTenge(scenario.recommended)}</p>
